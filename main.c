//
//  Crear procesos y regresar valores
//
//  Created by Antonio Junco de Haas A01339695
//  Con ayuda de Luis Revilla y Dalma
//
...
int main(int argc, char * argv[]) {
  ...
  //Opcion para ingresar n cantidad de procesos
